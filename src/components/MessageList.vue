<template>
  <ul class="message-list d-flex flex-column gap-2 bg-secondary p-4 rounded-2">
    <li
    ...
    >
      ...
      <button class="border-0 bg-transparent" :class="{ hidden: allowedMessageIndexes.includes(message.id) }" @click="emit('add', message.id)">
        <svg
          width="10"
          height="10"
          viewBox="0 0 10 10"
