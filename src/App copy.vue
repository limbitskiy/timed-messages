<template>
  ...
  >
    <div class="inner-container d-flex flex-column gap-4 overfwlow-hidden">
      ...
      <MessageList :messages="messages" :allowedMessageIndexes="allowedMessageIndexes" @add="onAddToLoop" />
...
const onRemoveCurrentFromLoop = () => {
  allowedMessageIndexes.value = allowedMessageIndexes.value.filter((id) => id !== currentMessageId.value);
};
